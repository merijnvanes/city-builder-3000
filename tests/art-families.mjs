...
export const FAMILY_LAYOUT_COUNTS = { civic: 12, power: 8, water: 4, parks: 5, transport: 9, rewards: 9, deals: 14 };
export const FAMILY_COUNTS = { civic: 12, power: 8, water: 4, parks: 3, transport: 5, rewards: 8, deals: 5 };
