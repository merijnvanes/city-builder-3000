export const EXPECTED_VARIANTS = { park: 3, seaport: 5 };
export const FAMILY_LAYOUT_COUNTS = { civic: 12, power: 8, water: 4, parks: 5, transport: 9 };
export const FAMILY_COUNTS = { civic: 12, power: 8, water: 4, parks: 3, transport: 5 };
