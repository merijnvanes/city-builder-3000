...
import { deckLift } from './deck-geometry.js';
export { bridgePlatform, bridgeSurfaceHeight } from './deck-geometry.js';
...
export function drawBridgeFrame(r, t) {
  ...
  if (index > 0 && index < total - 1 && (style === 'beam' || index % 3 === 1)) {
    const deck = s.elevation * ELEV_PX + deckLift(s.route), base = t.terrain === 'water' ? (t.waterLevel ?? t.elev) * ELEV_PX : t.elev * ELEV_PX;
