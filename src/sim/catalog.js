...
export const BUILDINGS = {
  ...
  coal:        { label: "Coal Plant",      group: "utilities", cost: 4000,  w: 4, h: 4, upkeep: 220, dept: "utilities", powerOut: 6000,  pollution: 60 },
  oil:         { label: "Oil Plant",       group: "utilities", cost: 6600,  w: 4, h: 4, upkeep: 260, dept: "utilities", powerOut: 7000,  pollution: 40 },
  gas:         { label: "Gas Plant",       group: "utilities", cost: 3000,  w: 3, h: 3, upkeep: 160, dept: "utilities", powerOut: 3000,  pollution: 18 },
  nuclear:     { label: "Nuclear Plant",   group: "utilities", cost: 15000, w: 4, h: 4, upkeep: 500, dept: "utilities", powerOut: 16000, pollution: 0 },
  ...
  waterpump:   { label: "Water Pump",      group: "utilities", cost: 150,   w: 1, h: 1, upkeep: 15,  dept: "utilities", waterOut: 2500, nearWater: true, powerUse: 2 },
  watertower:  { label: "Water Tower",     group: "utilities", cost: 100,   w: 1, h: 1, upkeep: 6,   dept: "utilities", waterOut: 600, powerUse: 1 },
  treatment:   { label: "Water Treatment", group: "utilities", cost: 5000,  w: 3, h: 3, upkeep: 160, dept: "utilities", waterOut: 4000, powerUse: 8, cleansWater: true },
  pipe:        { label: "Water Pipe",      group: "utilities", cost: 5,     w: 1, h: 1, upkeep: 0,   dept: "utilities", path: true, overlay: true, water: true },

  police:      { label: "Police Station",  group: "civic", cost: 500,  w: 3, h: 3, upkeep: 140, dept: "police",    service: { kind: "police", radius: 12, strength: 100 }, powerUse: 3, waterUse: 2 },
  fire:        { label: "Fire Station",    group: "civic", cost: 500,  w: 3, h: 3, upkeep: 140, dept: "fire",      service: { kind: "fire", radius: 12, strength: 100 }, powerUse: 3, waterUse: 2 },
  hospital:    { label: "Hospital",        group: "civic", cost: 600,  w: 3, h: 3, upkeep: 220, dept: "health",    service: { kind: "health", radius: 14, strength: 100 }, powerUse: 6, waterUse: 4 },
  school:      { label: "School",          group: "civic", cost: 250,  w: 3, h: 3, upkeep: 110, dept: "education", service: { kind: "education", radius: 12, strength: 80 }, powerUse: 3, waterUse: 2 },
  college:     { label: "College",         group: "civic", cost: 1000, w: 4, h: 4, upkeep: 200, dept: "education", service: { kind: "education", radius: 18, strength: 100 }, powerUse: 6, waterUse: 4 },
