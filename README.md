...
- **Neighbors**: roads, highways and rails to the map edge connect you to a named neighboring city for trade and garbage deals. Power lines and pipes enable power and water deals. Employment is local; connections do not add jobs.
